...
const generateShuffledFourDigitNumbers = () => {
  ...
  const handleSelectNumber = () => {
    ...
    if (shuffledNumbers.length > 0) {
      ...
      generateShuffledFourDigitNumbers()
    }
  };
    ...
    return(
        <Content style={contentStyle}>
            ...
            >
                {location.pathname ==='/user' && <div onClick={() => handleSelectNumber()} style={{position: 'fixed', top: '15%', right: '1%', zIndex: 100, cursor: 'pointer',textAlign: 'center', padding: '0.5rem', border: '1px solid rgb(248, 187, 80)', borderRadius:"10px"}} className="buy">
